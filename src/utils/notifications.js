...
export const notification = {
  ...
  po: {
    created: (poData) => {
      notification.success(
        ...
        `PO ID: ${poData.po_id || 'N/A'} | Total: ₹${poData.total_amount || '0.00'}`,
        { duration: 5000 }
      );
    },
  ...
  navigation: {
    redirecting: (destination) => {
      notification.info(`🧭 Redirecting to ${destination}...`, '', {
        duration: 2000
      });
    }
  }
